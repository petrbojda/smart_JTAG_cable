...
set rc [catch {
  ...
  add_files -quiet /home/petr/Projects/fpga/redpitaya/wrk/Smart_JTAG_cable/rtl/vivado/smart_jtag_cable.runs/synth_1/top_module.dcp
  ...
  set_param project.isImplRun false
  write_hwdef -force -file top_module.hwdef
