...
-- Date        : Sun Mar 24 19:50:34 2019
-- Host        : petr-dell running 64-bit Ubuntu 18.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/petr/Projects/fpga/redpitaya/wrk/Smart_JTAG_cable/rtl/vivado/smart_jtag_cable.srcs/sources_1/ip/processing_system7_0/processing_system7_0_sim_netlist.vhdl
...
entity processing_system7_0_processing_system7_v5_5_processing_system7 is
  ...
  attribute POWER of processing_system7_0_processing_system7_v5_5_processing_system7 : entity is "<PROCESSOR name={system} numA9Cores={2} clockFreq={666.666666} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={32} clockFreq={533.333333} readRate={0.5} writeRate={0.5} /><PLL domain={Processor} vco={1333.333} /><PLL domain={Memory} vco={1066.667} /><PLL domain={IO} vco={1600.000} /><AXI interface={M_AXI_GP0} dataWidth={32} clockFreq={10} usageRate={0.5} />/>";
...
entity processing_system7_0 is
  ...
  attribute X_CORE_INFO of processing_system7_0 : entity is "processing_system7_v5_5_processing_system7,Vivado 2018.3";
